...
function Veterinary() {
  ...
  const handleChange = (identifier, newValue) => dispatch(updateField(identifier, newValue));
      ...
      <div className="veterinary">
        ...
        <section className="profil">
          ...
          <div className="profil-inputs">
            {Object.keys(profil).filter((prop) => (prop !== "id" && prop !== "role" && prop !== "isOpen")).map((prop, index) => (
              <div key={prop} className="input-container">
                ...
                {focusedInput !== index
                  && <img src="../../../public/icons/write.png" alt="write icon" onClick={() => handleClickForFocus(index)} />}
                {focusedInput === index
